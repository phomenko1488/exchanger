export function Privacy() {
    return <>
        ...
        <p>We use Your Personal data to provide and improve the Service. By using the Service, You agree to the
            ...
            created with the help of the <a href="https://www.termsfeed.com/privacy-policy-generator/" target="_blank">TermsFeed
        ...
        <ul>
            ...
            <li>
                <p><strong>Company</strong> (referred to as either &quot;the
                    ...
                    PandaSwap, 1 Tuen Shun St, Tuen Mun, Hong-Kong, China.</p>
            </li>
            <li>
            ...
            <li>
                <p><strong>Website</strong> refers to PandaSwap, accessible from <a href="www.pandaswap.cn"
                                                                                    rel="external nofollow noopener"
                                                                                    target="_blank">www.pandaswap.cn</a>
                </p>
            </li>
            <li>
        ...
        <ul>
            <li>By email: support@pandaswap.cn</li>
        </ul>
    </>
}