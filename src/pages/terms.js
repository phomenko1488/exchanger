export function Terms() {
    return <>
        ...
        <p>These Terms will be applied fully and affect to your use of this Website. By using this Website, you agreed
            ...
            of the <a href="https://www.termsandcondiitionssample.com">Terms And Conditiions Sample Generator</a>.</p>

        <p>Minors or people below 18 years old are not allowed to use this Website.</p>

        <h2>Intellectual Property Rights</h2>

        <p>Other than the content you own, under these Terms, PandaSwap and/or its licensors own all the intellectual
        ...
        <p>Certain areas of this Website are restricted from being access by you and PandaSwap may further restrict
        ...
        <p>In these Website Standard Terms and Conditions, "Your Content" shall mean any audio, video text, images or
            other material you choose to display on this Website. By displaying Your Content, you grant PandaSwap a
        ...
        <p>Your Content must be your own and must not be invading any third-party's rights. PandaSwap reserves the right
            to remove any of Your Content from this Website at any time without notice.</p>

        <h2>No warranties</h2>

        <p>This Website is provided "as is," with all faults, and PandaSwap express no representations or warranties, of
        ...
        <p>In no event shall PandaSwap, nor any of its officers, directors and employees, shall be held liable for
            anything arising out of or in any way connected with your use of this Website whether such liability is
            under contract. PandaSwap, including its officers, directors and employees shall not be held liable for any
            indirect, consequential or special liability arising out of or in any way related to your use of this
            Website.</p>

        <h2>Indemnification</h2>

        <p>You hereby indemnify to the fullest extent PandaSwap from and against any and/or all liabilities, costs,
        ...
        <p>PandaSwap is permitted to revise these Terms at any time as it sees fit, and by using this Website you are
            expected to review these Terms on a regular basis.</p>

        <h2>Assignment</h2>

        <p>The PandaSwap is allowed to assign, transfer, and subcontract its rights and/or obligations under these Terms
        ...
        <p>These Terms constitute the entire agreement between PandaSwap and you in relation to your use of this
            Website, and supersede all prior agreements and understandings.</p>

        <h2>Governing Law & Jurisdiction</h2>

        <p>These Terms will be governed by and interpreted in accordance with the laws of the State of hk, and you
            submit to the non-exclusive jurisdiction of the state and federal courts located in hk for the resolution of
            any disputes.</p></>
}